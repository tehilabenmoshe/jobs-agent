...
Strongly prefer a posting's original source (the company's own career page, or its Greenhouse/Lever/Comeet page) over a copy on a general job-aggregator site — aggregator pages are often stale and keep showing a listing after the original has closed.
Prefer postings from the last 3 days. Only go back to 7 days if you cannot find enough recent ones.
